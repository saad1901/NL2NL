...
urlpatterns = [
    ...
    path('databases/<int:db_id>/update/', views.update_database_view, name='update_database'),
    path('databases/<int:db_id>/refresh-schema/', views.refresh_schema_view, name='refresh_schema'),
